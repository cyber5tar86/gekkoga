...
var App = function () {
  function App() {
    ...
    this.socket = io();
    this.socket.on('ui-update', function (data) {
  ...
  _createClass(App, [{
    ...
    value: function addEventListeners() {
      ...
      try {
        for (var _iterator = this.runButtons[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var button = _step.value;

          button.addEventListener(EventType.CLICK, function (e) {
            return _this.onRunButtonClick(e);
          });
        }
      } catch (err) {
      ...
      try {
        for (var _iterator2 = this.stopButtons[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var _button = _step2.value;

          _button.addEventListener(EventType.CLICK, function (e) {
            return _this.onStopButtonClick(e);
          });
        }
      } catch (err) {
      ...
      try {
        for (var _iterator3 = this.tomlButtons[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var _button2 = _step3.value;

          _button2.addEventListener(EventType.CLICK, function (e) {
            return _this.onTomlButtonClick(e);
          });
        }
      } catch (err) {
    ...
    value: function () {
      ...
      function onRunButtonClick(_x) {
        return _ref.apply(this, arguments);
      }

      return onRunButtonClick;
    }()
  }, {
    key: 'onStopButtonClick',
    value: function () {
      ...
      function onStopButtonClick(_x2) {
    ...
    key: 'onTomlButtonClick',
    value: function onTomlButtonClick(e) {
      try {
        var json = JSON.parse(e.target.dataset.json);
        var tomlText = _tomlJs2.default.dump(json);
        (0, _copyToClipboard2.default)(tomlText);
      } catch (e) {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return this.post(ApiEndpoint.RUN_CONFIG, { config: config });
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return this.post(ApiEndpoint.STOP_CONFIG);
    ...
    key: 'wait',
    value: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(time) {
...
},{"babel-polyfill":2,"copy-to-clipboard":3,"toml-js":330}],2:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":4,"core-js/shim":327,"regenerator-runtime/runtime":328}],3:[function(require,module,exports){
'use strict';
...
},{"toggle-selection":329}],4:[function(require,module,exports){
